...
- fluxo de compra com Passo 0 obrigatório para validar a reserva online; Expresso é o provedor padrão e iPlate permanece como alternativa, seguido de ingressos, cadastro individual das pessoas, regras, resumo, pagamento e QR Codes;
